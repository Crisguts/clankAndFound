                ...
                <p className="text-muted-foreground text-sm font-sans text-center mb-8">
                  ...
                  {isSuccess ? (
                    <div className="text-center py-6 animate-in fade-in zoom-in duration-300">
                      ...
                      <Button
                        asChild
                        className="w-full bg-primary text-primary-foreground rounded-full py-6 font-semibold transition-all hover:scale-105 hover:shadow-[0_0_20px_rgba(29,237,131,0.5)]"
                      >
