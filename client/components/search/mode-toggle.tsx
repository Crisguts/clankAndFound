    ...
    <div className="flex justify-center mb-8">
      ...
      <div className="bg-surface-1 rounded-full p-1">
        ...
        <div className="relative bg-surface-2 rounded-full p-1 border border-border flex">
          ...
          <div
            className={`absolute top-1 bottom-1 w-1/2 bg-primary rounded-full transition-all duration-300 ease-out shadow-[0_0_15px_var(--primary)] ${mode === "report" ? "left-1/2" : "left-0"
              }`}
            style={{ transform: mode === "report" ? "translateX(-4px)" : "translateX(4px)" }}
          />
